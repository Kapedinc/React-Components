...
const UntitledDesign3Remov: any = animated(
  styled('img')({
    height: `40px`,
    width: `134.23px`,
    objectFit: `cover`,
...
function Menu(props: MenuProps): JSX.Element {
  const [UntitledDesign3RemovSpring, UntitledDesign3RemovApi] = useSpring(
    () => ({
      config: {
        duration: 250,
      ...
      <Frame12>
        <Logo>
          <UntitledDesign3Remov
            onClick={() => {
              UntitledDesign3RemovApi.start({ ...{ opacity: 0 }, delay: 0 });
            }}
            style={{ ...UntitledDesign3RemovSpring }}
